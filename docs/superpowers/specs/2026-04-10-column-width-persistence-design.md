...
| ChartListView | `releaseYear`, `bpm`, `notes`, `ir` |
| SongListView | `releaseYear`, `bpm`, `chartCount`, `ir` |
| DifficultyTableView | `level`, `hasUrl`, `statusLabel` |
...
```json
{
  ...
  "fileLog": false,
  "columnWidths": {
    "chartList": { "title": 0.38, "artist": 0.26, "genre": 0.18, "eventName": 0.18 },
    "songList": { "title": 0.38, "artist": 0.26, "genre": 0.18, "eventName": 0.18 },
    "difficultyTable": { "title": 0.60, "artist": 0.40 },
